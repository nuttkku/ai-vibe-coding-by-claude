...
คู่มืออ้างอิงสำหรับวันที่ 2 เป็นต้นไป — วันที่ 1 ใช้แค่หน้าจอ Docker Desktop
...
> 💡 **`localhost` ใน container = ตัว container เอง** ไม่ใช่เครื่องเรา — นี่คือสาเหตุ error อันดับหนึ่ง (`ECONNREFUSED`) ตอนวันที่ 2
