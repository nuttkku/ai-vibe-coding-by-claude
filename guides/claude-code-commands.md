...
|---|---|---|
| 🖐️ **Manual** (`default`) | อ่านไฟล์ได้ — แก้ไฟล์และรันคำสั่ง **ต้องถามก่อน** | ผู้เริ่มต้น, งานสำคัญ — ใช้วันที่ 1–3 |
...
| 🤖 **Auto** (`auto`) | ทุกอย่าง มี classifier ตรวจเบื้องหลัง — **ค่าเริ่มต้นของแผน Pro/Max/Team** | งานยาว Sprint วันที่ 4 เมื่อ commit แล้ว + มีกฎ deny |
...
คำอธิบายทีละคำสั่งพร้อมแบบฝึก อยู่ใน [บทเรียนวันที่ 2 Claude Code Bootcamp](../day-2-bootcamp/README.md#-1-claude-code-bootcamp)
