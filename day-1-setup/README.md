...
| ⭐ ระดับ 1 | 35 นาที | 10 คำสั่งที่ใช้ทุกวัน |
| 🔧 ระดับ 2 | 15 นาที | ตั้งค่า, สิทธิ์, แก้ปัญหา |
| 🚀 ระดับ 3 | 10 นาที | คำสั่งขั้นสูง — รู้จักไว้ ใช้จริงวันที่ 3–5 |
| 🧩 สร้างเอง + 🧪 Lab รวม | 10 นาที | custom command + ใช้ทุกอย่างแก้บั๊กให้ test ผ่าน |
...
และปุ่มที่คู่กับคำสั่ง: **`Shift+Tab`** สลับโหมด (ปกติ → Accept edits → **Plan mode**) · **`Esc`** หยุด Claude · **`Esc Esc`** = `/rewind`
...
- 💡 `/cost` คล้ายกัน แต่แสดงเป็นค่าใช้จ่าย token — มีประโยชน์กับผู้ใช้แบบ API key มากกว่าแผน Pro · อ่านวิธีประหยัดใน [คู่มือโควต้า](../guides/claude-code-efficiency.md)

#### `/model` — เลือกรุ่นโมเดล
- **ทำอะไร:** สลับรุ่นของ Claude ที่ใช้ใน session
- **ใช้เมื่อ:** งานทั่วไปใช้รุ่นมาตรฐาน · งานยาก (ออกแบบระบบ, บั๊กที่หาไม่เจอ) ค่อยใช้รุ่นใหญ่ — รุ่นใหญ่กินโควต้ามากกว่า
- 🧪 **ลองเลย:** `/model` ดูว่าแผนของคุณเลือกรุ่นไหนได้บ้าง และตอนนี้ใช้รุ่นไหนอยู่
...
อ่านแผน → อนุมัติ → กลับโหมดปกติ → อ่านคำสั่งก่อนกด Yes ทุกครั้ง
